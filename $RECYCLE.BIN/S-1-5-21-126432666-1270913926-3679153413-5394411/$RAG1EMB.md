...
2. Open Preferences
   ...
   ![Image](./image_130_015.png)

3) Search for preference SUBSCMPL_grading_mode and set it's value to 1.

   ![Image](./image_130_016.png)

4) Search for preference MATERIALMGMT_material_creator_roles and add the following values (if not already added): Material Analyst, DBA, Compliance Officer, Compliance Admin.

   ![Image](./image_130_017.png)
 
5) Search for preference SUBSCMPL_regulation_creator_roles and add the following values (if not already added): Compliance officer, dba, Compliance Admin.

   ![Image](./image_130_018.png)
