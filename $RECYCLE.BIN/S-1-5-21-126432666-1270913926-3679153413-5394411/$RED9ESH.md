...
3. **Password Management:**  
   ...
   Refer to the table [Secrets Table](../../020_Operations/110_Hashicorp%20Vault%20access%20for%20operator%20users/060_Secrets%20Table.md) for fetching paths of above secrets in the Hashicorp Vault.

   **Recommendation:** Update these passwords post deployment. For instructions on password rotation, refer to the [Day N Password Rotation](../../020_Operations/050_Password%20Maintenance/020_On_Demand_Update/040_Day%20N%20Password%20Rotation/000_Intro.md) section and follow the Teamcenter cookbooks for the detailed procedures.
