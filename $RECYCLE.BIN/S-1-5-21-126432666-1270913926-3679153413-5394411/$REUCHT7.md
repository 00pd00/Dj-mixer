...
1. Ensure User Access Administrator and RBAC roles are [active in PIM](../../../../Reference%20Resources/150_Appendix/030_Activating%20Roles%20and%20Groups%20via%20PIM.md).
    ...
    - `Activate` the `[subscription name] Cell Provisioners` Group created in section [Create Groups for Your Subscriptions](../../020_Tools%20Access/010_Cloud%20Account%20Request/Azure/020_Setup%20Azure%20and%20Entra%20Groups%20and%20Roles.md#63-create-groups-for-your-subscriptions)
    ![Image](./image_141.png)
