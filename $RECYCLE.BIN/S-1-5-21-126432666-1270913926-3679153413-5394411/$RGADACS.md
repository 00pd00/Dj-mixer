...
2. Refer to [Ansible Templates Table](../../../../010_Tenant%20Onboarding/020_Basic%20Flow/020_Ansible%20Templates%20Table.md) for the operation run command (Password Maintenance) template link.
