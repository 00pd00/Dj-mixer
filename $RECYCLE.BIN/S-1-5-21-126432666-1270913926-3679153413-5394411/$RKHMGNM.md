...
=======
| GLBL_RANCHER_PROJECT_ID | The project id in Rancher | Refer to [Validate GLBL_RANCHER_PROJECT_ID and GLBL_RANCHER_CLUSTER_PROJECT_ID](./020_Create%20variable%20YAML%20for%20new%20AWS%20Account%20XCR%20cluster.md#validate-glbl_rancher_project_id-and-glbl_rancher_cluster_project_id) |
| GLBL_RANCHER_CLUSTER_PROJECT_ID | Project id of the rancher cluster | Refer to [Validate GLBL_RANCHER_PROJECT_ID and GLBL_RANCHER_CLUSTER_PROJECT_ID](./020_Create%20variable%20YAML%20for%20new%20AWS%20Account%20XCR%20cluster.md#validate-glbl_rancher_project_id-and-glbl_rancher_cluster_project_id) |
