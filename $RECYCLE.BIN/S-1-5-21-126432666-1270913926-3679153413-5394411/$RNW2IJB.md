...
<<<<<<< HEAD
    Note: For more details about adding any TC preference, please refer Teamcenter documentation for the respective preference. Eg: For TC2606 if you want to add above mentioned preference, please refer [teamcenter documentation](https://internal.docs.sw.siemens.com/documentation/internal/PL20250702463573610/en-US/AdminDataReport/Preferences/Fnd0PreferenceDefinition_NX_ETS_NXTRANSDIRECT_ENABLED_NX_ETS_NXTRANSDIRECT_ENABLED.html) for the preference.
=======
