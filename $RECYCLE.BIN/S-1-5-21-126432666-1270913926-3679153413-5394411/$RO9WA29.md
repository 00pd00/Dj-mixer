...
=======
dev | All | tcx-ai-preprod-eus-ai-secrets | KeyVaultSecretsUserPrecreated | tcx-ai-preprod-eus-kv | tcx-ai-preprod-eus-openai1-config | tcx-ai-preprod-eus-vision1-config
CApS prod | EastUS | tcx-ai-prod-eus-ai-secrets-prod | KeyVaultSecretsUserPrecreated | tcx-ai-prod-eus-kv | tcx-ai-prod-eus-openai1-config | tcx-ai-prod-eus-vision1-config
CApS dryrun | EastUS | tcx-ai-prod-eus-ai-secrets-dryrun | KeyVaultSecretsUserPrecreated | tcx-ai-prod-eus-kv | tcx-ai-prod-eus-openai1-config | tcx-ai-prod-eus-vision1-config
CApS prod | GermanyWestCentral | tcx-ai-prod-gwc-ai-secrets-prod | KeyVaultSecretsUserPrecreated | tcx-ai-prod-gwc-kv | tcx-ai-prod-gwc-openai1-config | tcx-ai-prod-gwc-vision1-config
CApS dryrun | GermanyWestCentral | tcx-ai-prod-gwc-ai-secrets-dryrun | KeyVaultSecretsUserPrecreated | tcx-ai-prod-gwc-kv | tcx-ai-prod-gwc-openai1-config | tcx-ai-prod-gwc-vision1-config

For older clusters using `GLBL_AZ_ENGINE_ROLE_POLICY == “dynamic”`, set GLBL_AI_AZ_VAULT_AZURE_KEYVAULT_ROLE to `KeyVaultSecretsUser`
