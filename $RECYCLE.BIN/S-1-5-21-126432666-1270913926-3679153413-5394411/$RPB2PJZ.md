...
1. **Shutdown workload in the tenant environment that is to be updated**  
    For Shutdown and Restart Template link, please refer to [Ansible Templates Table](../../Tenant%20Onboarding/Basic%20Flow/Ansible%20Templates%20Table) in Tower with these inputs.
